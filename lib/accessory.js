...
JablotronAccessory.prototype = {
    ...
    isPartiallyArmedAvailable: function() {
        // TODO: Implement this based on the service states which has the following body:
        // 'sections': [
        // {
        //     'cloud-component-id': 'SEC-1234',
        //     'name': 'Home',
        //     'can-control': True,
    ...
    mapState: function (segmentState, segmentInformations) {
        console.log("Mapping state for accessory " + this.getSegmentId() + " : " + segmentState);
        console.log(this.getSectionType())
        if (this.isPGM() && this.getSegmentId().startsWith("PG-")) {
            console.log("PGM state: " + segmentState);
            ...
            console.log("Thermometer state: " + segmentState);
            ...
            console.log("Section state: " + segmentState);
    ...
    mapAndUpdateState: function (segmentState, segmentInformations, callback) {
        ...
        console.log("Segmentinformations: " + segmentInformations)
