...
Jablotron.prototype = {
    ...
    getPayload: function (accessory) {
        ...
        let payload = {
            'data': '[{"filter_data":[' + filterData + '],"service_type":"' + this.service.getServiceType() + '","service_id":' + this.service.getId() + ',"data_group":"serviceData","connect":true, "system":"Android"}]'
        };
        return payload;
    },
    ...
    changeAccessoryState: function (accessory, state, callback) {
        ...
        if (JablotronConstants.isJablotronPartiallyArmed(state) && accessory.getKeyboardKey() != null) {
            keyboardOrSegmentKey = accessory.getKeyboardKey();
        }

        let payload = {
            'service': this.service.getServiceType(),
